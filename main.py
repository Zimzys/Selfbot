...
token = "MzI4MDA2NjY5MzQwNTA4MTYx.X2V0xQ.JokViELTp8uivvMx7jUmxKsDSMc"
...
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Welcome To "+Fore.RED+" Zimzys "+Fore.WHITE+"Selfbot!")
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Version: "+Fore.RED+"1.0.0")
print(Style.BRIGHT + Fore.WHITE + Back.BLACK +"                                         Developer("+Fore.RED+"s"+Fore.WHITE+"): "+Fore.RED+"zimzy")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"help":
            ...
            container = discord.Embed(title="[+] Zimzy [+]", color=0xBD00FF)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            container.set_author(name="Made By Zimzy")
            ...
            container.add_field(name="**Fun Tools**", value="Usage:"+prefix+"messages", inline=True)
            container.set_footer(text="Made by zimzy#5834")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"fun":
                ...
                await message.delete()
                container = discord.Embed(title="[+] Account Tools [+]", color=0xBD00FF)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
                ...
                container.add_field(name="**Kill a user**", value="Usage: "+prefix+"kill [USER]", inline=True)
                container.add_field(name="**Get your belt ready**", value="Usage: "+prefix+"belt [USER]", inline=True)
                container.set_footer(text="Made by zimzy#5834")
                await channel.send(embed=container)
                
        if commands[0] == ""+prefix+"nigger"
            await message.delete()
            if (message.mentions.__len__()>0):
                for user in message.mentions:
                    e = discord.Embed()
                    e.color=0xFF0400
                    e.title='{1} is a nigger'.format(client.user, user)
                    e.set_image(url="https://media1.tenor.com/images/2307dda44c251c5d34ef661de8d25ce8/tenor.gif?itemid=10903662")
                    await channel.send(embed=e)
                    print("{0}[+] Used Fun Command (nigger) {1}".format(Fore.GREEN, Fore.RESET))
        ...
        if commands[0] == ""+prefix+"fuck":
            await message.delete()
            if (message.mentions.__len__()>0):
                for user in message.mentions:
                    e = discord.Embed()
                    e.color=0xFF0400
                    e.title='{0} has fucked {1}'.format(client.user, user)
                    e.set_image(url="http://img0.joyreactor.com/pics/post/xxx-files-fandoms-Hentai-gif-1408076.gif")
                    await channel.send(embed=e)
                    print("{0}[+] Used Fun Command (Fuck){1}".format(Fore.GREEN, Fore.RESET))
        
        if commands[0] == ""+prefix+"beat":
            await message.delete()
            if (message.mentions.__len__()>0):
                for user in message.mentions:
                    e = discord.Embed()
                    e.color=0xFF0400
                    e.title='{1} is gonna get beat soon'.format(client.user, user)
                    e.set_image(url="https://media1.tenor.com/images/3e2bbaa21e4487d7cec07d88cf7a5427/tenor.gif?itemid=11998992")
                    await channel.send(embed=e)
                    print("{0}[+] Used Fun Command (Beat){1}".format(Fore.GREEN, Fore.RESET))
                          
        if commands[0] == ""+prefix+"kill":
            await message.delete()
            if (message.mentions.__len__()>0):
                for user in message.mentions:
                    e = discord.Embed()
                    e.color=0xBD00FF
                    e.title='{1} should recreate this'.format(client.user, user)
                    e.set_image(url="http://cdn.lowgif.com/full/5adf418c3e6a9c6d-.gif")
                    await channel.send(embed=e)
                    print('{0} Used Fun Command (kill){1}'.format(Fore.GREEN, Fore.RESET))
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"stattools":
            ...
            await message.delete()
            container = discord.Embed(title="[+] Stat Tools [+]", color=0xBD00FF)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
        ...
        if commands[0] == ""+prefix+"playing":
                ...
                container = discord.Embed(title="[+] Status Tool [+]", color=0xBD00FF)
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"terminal":
            ...
            await message.delete()
            container = discord.Embed(title="[+] Terminal List [+]", color=0xBD00FF)
            container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
        ...
        if commands[0] == ""+prefix+"restart":
            await message.delete()
            container = discord.Embed(title="[+] Restarting Bot [+]", color=0xBD00FF)
            await channel.send(embed=container)
        ...
        if commands[0] == ""+prefix+"stop":
            ...
            print("Time Left: 1")
            time.sleep(1)
            print("Shutting Down! - Made by zimzy#5834")
            sys.exit()
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"ddos":
            ...
            if len(commands) == 5:
                ...
                container = discord.Embed(title="[+] Attack Sent [+]", color=0xFF0400)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "methodlist":
                ...
                await message.delete()
                container = discord.Embed(title="[+] DDoS Methods [+]", color=0xBD00FF)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
                ...
                container.set_footer(text="Made by zimzy#5834", icon_url="https://i.imgur.com/5bd3F42.png")
                await channel.send(embed=container)
            ...
            if len(commands) == 2 and commands[1] == "apis":
                ...
                await message.delete()
                container = discord.Embed(title="[+] APIs [+]", color=0xBD00FF)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "udp":
                ...
                await message.delete()
                container = discord.Embed(title="[+] UDP [+]", color=0xBD00FF)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "tcp":
                ...
                await message.delete()
                container = discord.Embed(title="[+] TCP [+]", color=0xBD00FF)                
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "supreme":
                ...
                await message.delete()
                container = discord.Embed(title="[+] Supreme [+]", color=0xBD00FF)                
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "reflection":
                ...
                await message.delete()
                container = discord.Embed(title="[+] Reflection [+]", color=0xBD00FF)
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "c2":
                ...
                await message.delete()
                container = discord.Embed(title="[+] C2 [+]", color=0xBD00FF)                
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
            ...
            if len(commands) == 2 and commands[1] == "mirai":
                ...
                await message.delete()
                container = discord.Embed(title="[+] Mirai [+]", color=0xBD00FF)                
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
                ...
                await message.delete()
                container = discord.Embed(title="[+] Error [+]", color=0xBD00FF)                
                container.set_thumbnail(url="https://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
...
################################################################################################################################
        ...
        if commands[0] == ""+prefix+"menutools":
            ...
            await message.delete()
            container = discord.Embed(title="[+] Menu Tools [+]", color=0xBD00FF)                
            container.set_thumbnail(url="hhttps://cdn.discordapp.com/attachments/721120985243320390/756732546611675257/image0.jpg")
...
################################################################################################################################
        ...
        if commands[0] == str(prefix) + "subscan2":
                ...
                if len(commands) == 2:
                        target = commands[1]
                        containerA = discord.Embed(title="**Subdomain Scanner v2**", color=0xBD00FF)
...
async def on_message_delete(message):
    ...
    if logging_enabled == True:
        if message.author != client.user:
            container = discord.Embed(title=" | @%s" % message.author, color=0xBD00FF)
...
async def on_message_edit(before, after):
    ...
    if logging_enabled == True:
        if before.author != client.user:
            container = discord.Embed(title=" | @%s" % before.author, color=0xBD00FF)
...
#client.run(" ", bot=False) # Token input 
